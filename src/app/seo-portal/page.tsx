...
export default function SEOPortalLoginPage() {
      ...
      >
        ...
        >
          ...
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold text-white mb-2">Welcome to SEO Portal</h1>
            <p className="text-white/50">Login to access your SEO dashboard</p>
          </div>
